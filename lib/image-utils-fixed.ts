import { urlFor } from "./sanity-client-fixed"
...
export function getPoemImageUrl(coverImage: any): string {
  ...
  return imageConfig.defaultPoemImage || "/images/poetry-bg-1.jpg"
}
...
export function getPoetImageUrl(image: any): string {
  ...
  return imageConfig.defaultPoetImage || "/images/poet-default.png"
}
...
export function getCollectionImageUrl(image: any): string {
  ...
  return imageConfig.defaultCollectionImage || "/images/collection-default.png"
}
