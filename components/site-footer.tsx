    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-xl font-serif font-semibold mb-4">VersesVibez</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/poets" className="text-gray-400 hover:text-white transition-colors">
                  Poets
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/image-guide" className="text-gray-400 hover:text-white transition-colors">
                  Image Guide
                </Link>
              </li>
            </ul>
